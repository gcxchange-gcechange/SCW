define([], function() {
  return {
    ...
    "paragrapheHome": "Collaborate with colleagues across departments using Microsoft Teams and Sharepoint. Share ideas and documents with both applications through GCXchange.",
    ...
    "paragrapheTemplate": "SharePoint is your community’s site that promotes your community to GCXhange visitors. Select a template that best fits your community's purpose. You will be able to modify it once it has been created.",
    "titleSpace": "Give your community a bilingual name",
    "paragrapheSpace": "A bilingual name complies with the Official Languages Act and makes it easier for others to find your SharePoint community in the GCXchange Catalogue.",
    ...
    "phLetusEn": "Describe your community and its purpose in English.",
    "phLetusFr": "Describe your community and its purpose in French.",
    "phBusinessReason": "Explain the purpose of this community",
    "titleOwners": "Invite owners",
    "paragrapheOwners": "As a GCXchange Owner you can modify your SharePoint site and invite other users to your community so they can collaborate with you in Microsoft Teams. We will provide you with detailed information on adding users when your space is created.",
